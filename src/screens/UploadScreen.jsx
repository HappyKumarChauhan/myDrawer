  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}> 
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: colors.color }]}>Upload</Text>
      ...
      <View style={styles.uploadContainer}>
        <TouchableOpacity style={[styles.uploadButton, { backgroundColor: colors.secondaryBg }]}> 
      ...
      <Text style={[styles.sectionTitle, { color: colors.color }]}>Uploading Photos</Text>
      <FlatList
        data={photos}
        ...
        renderItem={({ item }) => (
          <View style={[styles.photoCard, { backgroundColor: colors.secondaryBg }]}> 
            ...
            <View style={styles.photoInfo}>
              <Text style={[styles.photoName, { color: colors.color }]}>{item.name}</Text>
...
const styles = StyleSheet.create({
  ...
  iconButton: { width: 50, height: 50, justifyContent: 'center', alignItems: 'center', borderRadius: 50, elevation: 5 },
  ...
  photoSize: { fontSize: 12 },
  nextButton: { flexDirection: 'row', padding: 12, borderRadius: 8, alignItems: 'center', justifyContent: 'space-between', marginTop: 20 },
